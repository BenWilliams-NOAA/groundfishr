...
DATA_SECTION
 ...
 ////////////////////////////////////////////////////////////////////////////
  ...
  init_int nyrs_catch    // Number of years that catch is specified (starting at first year: styr)
 ...
 END_CALCS
  ...
  // !! for (int i=1;i<=nspp;i++)
  init_matrix Obs_Catch(1,nyrs_catch,0,nspp) // Pre-specified catch values (year is in column 0)
...
// "END: Read in dimensioning parameters and constraints"
 ...
 LOCAL_CALCS
  ...
  cout<<R<<endl;
 END_CALCS
  matrix wt_mature(1,nspp,1,nages)
  ...
  matrix F_begin_yr(1,nyrs_catch,1,nspp) ; // F that gives TAC in TAC year
  vector Fabc(1,nspp)
  vector F40(1,nspp)
  vector Fofl(1,nspp)
...
FUNCTION Get_ABCs(const int& ispp)
